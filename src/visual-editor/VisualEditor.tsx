...
import { Play, Download, Save, Settings, Code, Eye, AlertCircle, CheckCircle } from 'lucide-react'

// 导入核心引擎
import { VisualProgrammingEngine, VisualProject, VisualNode, VisualEdge } from './core/engine'
import { CodeCompiler, CompileOptions, CompileResult } from './core/compiler'
...
import { StudentTeacherFeatures } from "../education/StudentTeacherFeatures"
import { KnowledgeExplorer } from "../education/KnowledgeExplorer"
import { SubjectFolderManager, LearningPathPlanner } from "../education/SubjectManager"
import { InteractiveTutorial, AchievementGallery } from "../education/TutorialSystem"
import { GamificationSystem, SmartRecommendation, MultiLanguageSupport } from "../education/AdvancedFeatures"
import { EducationFeatureModal, EducationQuickEntry } from "../education/EducationModal"
import { AICodeAssistant, RealTimeCollaboration, ProgressVisualization, MobileOptimizedInterface } from "../education/AdvancedIntegration"
          ...
          {educationConfig && (
            <div className="w-80 bg-white border-r border-gray-200 overflow-y-auto">
              ...
              <div className="p-4 border-t border-gray-200">
                ...
                >
                  <span>{showEducationFeatures ? '收起' : '展开'}高级教育功能</span>
